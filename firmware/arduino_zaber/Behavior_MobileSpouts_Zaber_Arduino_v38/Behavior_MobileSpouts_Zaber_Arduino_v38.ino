// v38 (2026-08-10): interrupt-driven lick-onset capture (see lickISR()/updateLick()). The v37 polled
// debounce was a lockout that dropped brief/fast contacts, so the ENL was not enforced on ~16% of real
// licks the DAQ recorded. A CHANGE interrupt on PIN_LICK_IN now latches every onset. Serial protocol
// unchanged from v36/v37. NOT yet bench-tested -- flash + verify lick_on/pre_cue_reset before deploying.
#include <Wire.h>
